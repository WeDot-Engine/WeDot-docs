...
<!-- 原文件：https://github.com/WeDot-Engine/WeDot/tree/master/modules/webrtc/doc_classes/WebRTCDataChannelExtension.xml。 -->

<div id="_class_webrtcdatachannelextension"></div>

# WebRTCDataChannelExtension

**继承：** [`WebRTCDataChannel`](class_webrtcdatachannel.md) **<** [`PacketPeer`](class_packetpeer.md) **<** [`RefCounted`](class_refcounted.md) **<** [`Object`](class_object.md)
...
|||
|:-:|:--|
| `void`                                               | [`_close`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__close) ( ) virtual[^virtual]                                                                                |
| [`int`](class_int.md)                                | [`_get_available_packet_count`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_available_packet_count) ( ) virtual[^virtual] const[^const]                        |
| [`int`](class_int.md)                                | [`_get_buffered_amount`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_buffered_amount) ( ) virtual[^virtual] const[^const]                                      |
| [`int`](class_int.md)                                | [`_get_id`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_id) ( ) virtual[^virtual] const[^const]                                                                |
| [`String`](class_string.md)                          | [`_get_label`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_label) ( ) virtual[^virtual] const[^const]                                                          |
| [`int`](class_int.md)                                | [`_get_max_packet_life_time`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_max_packet_life_time) ( ) virtual[^virtual] const[^const]                            |
| [`int`](class_int.md)                                | [`_get_max_packet_size`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_max_packet_size) ( ) virtual[^virtual] const[^const]                                      |
| [`int`](class_int.md)                                | [`_get_max_retransmits`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_max_retransmits) ( ) virtual[^virtual] const[^const]                                      |
| [Error](#enum_@globalscope_error)                    | [`_get_packet`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_packet) ( r_buffer: `const uint8_t **`, r_buffer_size: `int32_t*` ) virtual[^virtual]              |
| [`String`](class_string.md)                          | [`_get_protocol`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_protocol) ( ) virtual[^virtual] const[^const]                                                    |
| [ChannelState](#enum_webrtcdatachannel_channelstate) | [`_get_ready_state`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_ready_state) ( ) virtual[^virtual] const[^const]                                              |
| [WriteMode](#enum_webrtcdatachannel_writemode)       | [`_get_write_mode`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__get_write_mode) ( ) virtual[^virtual] const[^const]                                                |
| [`bool`](class_bool.md)                              | [`_is_negotiated`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__is_negotiated) ( ) virtual[^virtual] const[^const]                                                  |
| [`bool`](class_bool.md)                              | [`_is_ordered`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__is_ordered) ( ) virtual[^virtual] const[^const]                                                        |
| [Error](#enum_@globalscope_error)                    | [`_poll`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__poll) ( ) virtual[^virtual]                                                                                  |
| [Error](#enum_@globalscope_error)                    | [`_put_packet`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__put_packet) ( p_buffer: `const uint8_t*`, p_buffer_size: [`int`](class_int.md) ) virtual[^virtual]     |
| `void`                                               | [`_set_write_mode`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__set_write_mode) ( p_write_mode: [WriteMode](#enum_webrtcdatachannel_writemode) ) virtual[^virtual] |
| [`bool`](class_bool.md)                              | [`_was_string_packet`](class_webrtcdatachannelextension.md#class_webrtcdatachannelextension_private_method__was_string_packet) ( ) virtual[^virtual] const[^const]                                          |
