...
<!-- 原文件：https://github.com/WeDot-Engine/WeDot/tree/master/doc/classes/Rect2i.xml。 -->
...
Returns `true` if this rectangle has positive width and height. See also [`get_area`](class_rect2i.md#class_rect2i_method_get_area).
